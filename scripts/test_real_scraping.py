#!/usr/bin/env python3
"""
Test real web scraping for 14ers.com
"""
...
def test_real_14ers():
 """Test real 14ers.com scraping."""
 console.print("[bold green]Testing Real 14ers.com Scraping...[/bold green]\n")

 # Create scraper instance
 scraper = FourteenersRealScraper()

 # Try to scrape with 7 day lookback
 console.print("Attempting to scrape recent trip reports (7 day lookback)...")
 ...
 table.add_column("Trail", style="blue", max_width=30)
 ...
 console.print("\n No wildlife sightings found in recent reports")
 console.print("This could mean:")
 console.print(" - No recent trip reports mention wildlife")
 console.print(" - The website structure has changed")
 console.print(" - Connection issues")
