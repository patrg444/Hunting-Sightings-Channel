                  ...
                  <>
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        max="150"
                        step="1"
                        value={filters.maxLocationAccuracy || 100}
                        onChange={(e) => updateFilters({ maxLocationAccuracy: parseInt(e.target.value) })}
                        className="flex-1"
                      />
                      <span className="text-sm text-gray-600 dark:text-gray-400 w-16 text-right">
                        ≤ {filters.maxLocationAccuracy || 100} mi
                      </span>
                    </div>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Only show locations with accuracy better than {filters.maxLocationAccuracy || 100} miles
                    </p>
                  </>
                )}
              </div>
